...
# Consumption dataset and generate the plot 4 as required by the
...
# described as plot4 in the assignment description
#======================================================================
...
# Change the grid arrangement to hold 4 plots, 2x2 row-wise
par(mfrow = c(2,2))
...
legend("topright", inset = 0.02, legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col = c("black","red","blue"), lty = c(1,1,1), box.lty = 0)
